...
This is the **platform-agnostic** edition. For CodeBuddy-specific optimizations (team tools, inter-agent messaging), see the [CodeBuddy edition](https://github.com/Luo-CJL/coupling-aware-debug).
